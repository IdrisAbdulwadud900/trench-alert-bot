...
# ========================
# NOTE: Wallet and List storage has been moved to dedicated modules:
# - wallets.py handles wallet tracking (wallets.json)
# - lists.py handles list/narrative tracking (lists.json)
# This prevents data corruption from mixing storage locations.
# ========================
